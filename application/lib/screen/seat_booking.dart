...
class VanLayout extends StatefulWidget {
  VanLayout({required this.number, required this.station});

  final String number;
  final String station;

  @override
  State<VanLayout> createState() => _VanLayoutState();
}

class _VanLayoutState extends State<VanLayout> {
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Flexible(
              child: Container(
                margin: const EdgeInsets.fromLTRB(150, 50, 0, 0),
